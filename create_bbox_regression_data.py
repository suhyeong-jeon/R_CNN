...
if __name__ == '__main__':
    ...
    for sample_name in samples:
        ...
        positive_bndboxes = np.loadtxt(positive_annotation_path, dtype=np.int64, delimiter=' ')
